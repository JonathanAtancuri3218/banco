...
a persistence unit "banco2PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "banco2\pom.xml":
...
artifact ("banco2.war") is already built. You can build
